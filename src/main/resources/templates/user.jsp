...
.re {
    border: 2px solid #8fd7c7; /* Add a border with your desired color */
    padding: 70px; /* Add padding for spacing inside the box */
    box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.2); /* Add a shadow effect */
...
/* Define the outline style for the button */
.outline-button {
    border: 2px solid #023b49; /* Set the outline color (blue in this example) */
...
.outline-button:hover {
    background-color: #023b49; /* Change background color on hover */
...
<br>
    ...
    <div class="text-box">
      ...
      <div class="re">
        ...
        <h3> You Haven't Started Any Course On CourseCrafter   <h3>
        <br>
        <br>
        <br>
<div class="bu">
    <a href="#">
       <button class="outline-button">Start Course</button>
    </a>
</div>
    </div>
    </div>
